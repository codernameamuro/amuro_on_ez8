...
public class Order {
	...
	// 치즈 종류 // 선택안함 추가
	private Map<Integer, String> cheeseMap = Map.of(1, "슈레드 치즈", 2, "아메리칸 치즈", 3, "체다 치즈", 4, "선택 안함");
	// 슈레드치즈 아메리칸치즈 체다 치즈 선택안함

	// 소스 종류
	// 스위트 랜치 칠리 소금 후추 올리브오일 선택안함
	private Map<Integer, String> sauceMap = Map.of(1, "스위트", 2, "랜치", 3, "칠리", 4, "소금", 5, "후추", 6, "올리브 오일", 7,
			"선택 안함");
	...
	public String fireOrder(String fire) {
		...
		case 1:
			System.out.println("빵을 구워드리겠습니다.");
			return "1";
		case 2:
			System.out.println("빵을 안 구운 채로 드리겠습니다.");
			return "2";
		}
		return null;
	}
