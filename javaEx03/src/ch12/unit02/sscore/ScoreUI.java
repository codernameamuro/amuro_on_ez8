...
public class ScoreUI {
	...
	public void menu() {
		...
		System.out.println("\t>>성적처리-ArrayList : 정렬<<");
		
		while(true) {
			try {
				do {
					System.out.println("1.등록 2.수정 3.삭제 4.리스트 5.학번검색 6.이름검색 7.총점내림차순 8.종료 =>");
	...
	public void totDesc() {
		...
		// 총점 내림차순
		Comparator<ScoreVO> list2 = new Comparator<ScoreVO>() {
